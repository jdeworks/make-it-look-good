...
export function NavBottomMobile({ activeTab: controlledTab, onTabChange }) {
  ...
  return (
    <nav
      className="fixed bottom-0 inset-x-0 z-40 bg-white dark:bg-slate-800 border-t border-slate-200 dark:border-slate-700 safe-area-bottom"
